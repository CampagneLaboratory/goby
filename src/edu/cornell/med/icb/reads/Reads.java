...
public final class Reads {
  ...
  public static final class ReadCollection extends
    ...
    private static final ReadCollection defaultInstance = new ReadCollection();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return edu.cornell.med.icb.reads.Reads.internal_static_reads_ReadCollection_descriptor;
    }
    
    @Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return edu.cornell.med.icb.reads.Reads.internal_static_reads_ReadCollection_fieldAccessorTable;
    }
    
    // repeated .reads.ReadEntry reads = 1;
    public static final int READS_FIELD_NUMBER = 1;
    private java.util.List<edu.cornell.med.icb.reads.Reads.ReadEntry> reads_ =
      java.util.Collections.emptyList();
    public java.util.List<edu.cornell.med.icb.reads.Reads.ReadEntry> getReadsList() {
      return reads_;
    }
    public int getReadsCount() { return reads_.size(); }
    public edu.cornell.med.icb.reads.Reads.ReadEntry getReads(int index) {
      return reads_.get(index);
    }
    
    @Override
    public final boolean isInitialized() {
      for (edu.cornell.med.icb.reads.Reads.ReadEntry element : getReadsList()) {
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadCollection parseFrom(
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadCollection parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static edu.cornell.med.icb.reads.Reads.ReadCollection parseFrom(
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadCollection parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadCollection parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeDelimitedFrom(input).buildParsed();
    }
    public static edu.cornell.med.icb.reads.Reads.ReadCollection parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistry extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(edu.cornell.med.icb.reads.Reads.ReadCollection prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using edu.cornell.med.icb.reads.Reads.ReadCollection.newBuilder()
      private Builder() {}
      
      edu.cornell.med.icb.reads.Reads.ReadCollection result = new edu.cornell.med.icb.reads.Reads.ReadCollection();
      
      @Override
      protected edu.cornell.med.icb.reads.Reads.ReadCollection internalGetResult() {
        return result;
      }
      
      @Override
      public Builder clear() {
        result = new edu.cornell.med.icb.reads.Reads.ReadCollection();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return edu.cornell.med.icb.reads.Reads.ReadCollection.getDescriptor();
      }
      
      public edu.cornell.med.icb.reads.Reads.ReadCollection getDefaultInstanceForType() {
        return edu.cornell.med.icb.reads.Reads.ReadCollection.getDefaultInstance();
      }
      
      public edu.cornell.med.icb.reads.Reads.ReadCollection build() {
      ...
      private edu.cornell.med.icb.reads.Reads.ReadCollection buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw new com.google.protobuf.UninitializedMessageException(
      ...
      public edu.cornell.med.icb.reads.Reads.ReadCollection buildPartial() {
        if (result == null) {
        ...
        edu.cornell.med.icb.reads.Reads.ReadCollection returnMe = result;
        result = null;
        return returnMe;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof edu.cornell.med.icb.reads.Reads.ReadCollection) {
          return mergeFrom((edu.cornell.med.icb.reads.Reads.ReadCollection)other);
        } else {
      ...
      public Builder mergeFrom(edu.cornell.med.icb.reads.Reads.ReadCollection other) {
        if (other == edu.cornell.med.icb.reads.Reads.ReadCollection.getDefaultInstance()) return this;
        if (!other.reads_.isEmpty()) {
          if (result.reads_.isEmpty()) {
            result.reads_ = new java.util.ArrayList<edu.cornell.med.icb.reads.Reads.ReadEntry>();
          }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              edu.cornell.med.icb.reads.Reads.ReadEntry.Builder subBuilder = edu.cornell.med.icb.reads.Reads.ReadEntry.newBuilder();
      ...
      public Builder setReads(int index, edu.cornell.med.icb.reads.Reads.ReadEntry value) {
        if (value == null) {
      ...
      public Builder setReads(int index, edu.cornell.med.icb.reads.Reads.ReadEntry.Builder builderForValue) {
        result.reads_.set(index, builderForValue.build());
        return this;
      }
      public Builder addReads(edu.cornell.med.icb.reads.Reads.ReadEntry value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.reads_.isEmpty()) {
      ...
      public Builder addReads(edu.cornell.med.icb.reads.Reads.ReadEntry.Builder builderForValue) {
        if (result.reads_.isEmpty()) {
          result.reads_ = new java.util.ArrayList<edu.cornell.med.icb.reads.Reads.ReadEntry>();
        }
      ...
      public Builder addAllReads(
          java.lang.Iterable<? extends edu.cornell.med.icb.reads.Reads.ReadEntry> values) {
        if (result.reads_.isEmpty()) {
          result.reads_ = new java.util.ArrayList<edu.cornell.med.icb.reads.Reads.ReadEntry>();
        }
    ...
    static {
      edu.cornell.med.icb.reads.Reads.getDescriptor();
    }
  }
  ...
  public static final class ReadEntry extends
    ...
    private static final ReadEntry defaultInstance = new ReadEntry();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return edu.cornell.med.icb.reads.Reads.internal_static_reads_ReadEntry_descriptor;
    }
    
    @Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return edu.cornell.med.icb.reads.Reads.internal_static_reads_ReadEntry_fieldAccessorTable;
    }
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadEntry parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadEntry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static edu.cornell.med.icb.reads.Reads.ReadEntry parseFrom(
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadEntry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static edu.cornell.med.icb.reads.Reads.ReadEntry parseFrom(
    ...
    public static edu.cornell.med.icb.reads.Reads.ReadEntry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeDelimitedFrom(input).buildParsed();
    }
    public static edu.cornell.med.icb.reads.Reads.ReadEntry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistry extensionRegistry)
        throws java.io.IOException {
      return newBuilder().mergeDelimitedFrom(input, extensionRegistry)
    ...
    public static Builder newBuilder() { return new Builder(); }
    public Builder newBuilderForType() { return new Builder(); }
    public static Builder newBuilder(edu.cornell.med.icb.reads.Reads.ReadEntry prototype) {
      return new Builder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder> {
      // Construct using edu.cornell.med.icb.reads.Reads.ReadEntry.newBuilder()
      private Builder() {}
      
      edu.cornell.med.icb.reads.Reads.ReadEntry result = new edu.cornell.med.icb.reads.Reads.ReadEntry();
      
      @Override
      protected edu.cornell.med.icb.reads.Reads.ReadEntry internalGetResult() {
        return result;
      }
      
      @Override
      public Builder clear() {
        result = new edu.cornell.med.icb.reads.Reads.ReadEntry();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return edu.cornell.med.icb.reads.Reads.ReadEntry.getDescriptor();
      }
      
      public edu.cornell.med.icb.reads.Reads.ReadEntry getDefaultInstanceForType() {
        return edu.cornell.med.icb.reads.Reads.ReadEntry.getDefaultInstance();
      }
      
      public edu.cornell.med.icb.reads.Reads.ReadEntry build() {
        if (result != null && !isInitialized()) {
          throw new com.google.protobuf.UninitializedMessageException(
            result);
        }
      ...
      private edu.cornell.med.icb.reads.Reads.ReadEntry buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw new com.google.protobuf.UninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public edu.cornell.med.icb.reads.Reads.ReadEntry buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");  }
        edu.cornell.med.icb.reads.Reads.ReadEntry returnMe = result;
        result = null;
        return returnMe;
      }
      ...
      @Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof edu.cornell.med.icb.reads.Reads.ReadEntry) {
          return mergeFrom((edu.cornell.med.icb.reads.Reads.ReadEntry)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(edu.cornell.med.icb.reads.Reads.ReadEntry other) {
        if (other == edu.cornell.med.icb.reads.Reads.ReadEntry.getDefaultInstance()) return this;
  ...
  result.hasSequence = true;
      ...
      public Builder clearSequence() {
        ...
        result.sequence_ = com.google.protobuf.ByteString.EMPTY;
        return this;
      }
  ...
  result.hasQualityScores = true;
      ...
      public Builder clearQualityScores() {
        ...
        result.qualityScores_ = com.google.protobuf.ByteString.EMPTY;
        return this;
      }
    }
  ...
  static {
    java.lang.String descriptorData =
      "\n)src/edu/cornell/med/icb/reads/Reads.pr" +
      "oto\022\005reads\"1\n\016ReadCollection\022\037\n\005reads\030\001 " +
      "\003(\0132\020.reads.ReadEntry\"\210\001\n\tReadEntry\022\021\n\tr" +
      "eadIndex\030\001 \002(\r\022\026\n\016readIdentifier\030\027 \001(\t\022\023" +
      "\n\013description\030\026 \001(\t\022\022\n\nreadLength\030\002 \002(\r\022" +
      "\020\n\010sequence\030\003 \001(\014\022\025\n\rqualityScores\030\004 \001(\014" +
      "B\035\n\031edu.cornell.med.icb.readsH\001";
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_reads_ReadCollection_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              edu.cornell.med.icb.reads.Reads.ReadCollection.class,
              edu.cornell.med.icb.reads.Reads.ReadCollection.Builder.class);
          internal_static_reads_ReadEntry_descriptor =
          ...
          internal_static_reads_ReadEntry_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              edu.cornell.med.icb.reads.Reads.ReadEntry.class,
              edu.cornell.med.icb.reads.Reads.ReadEntry.Builder.class);
          return null;
        }
      };
