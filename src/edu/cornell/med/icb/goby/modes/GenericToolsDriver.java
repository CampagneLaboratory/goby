...
public class GenericToolsDriver extends AbstractCommandLineMode {
    ...
    /**
     * Load the list of MaqTools modes from modes-list.txt which is generated by "compile"
     * in the build.xml ant script. This is necessary because
     *
     * @return the mode map
     */
    private Map<String, Class> loadModeMap() {
        ...
        for (final String modeClassName : modesClassNamesList()) {
            try {
                ...
                System.err.println(
                        "Could not find MODE_NAME for class " + modeClassName
                                + " InstantiationException: " + e.getMessage());  //To change body of catch statement use File | Settings | File Templates.
            }
        }
        return modeMap;
    }
    ...
    /**
     * Retrieve the class names of the likely MaqTool Modes.
     *
