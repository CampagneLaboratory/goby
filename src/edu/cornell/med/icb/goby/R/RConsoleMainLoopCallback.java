...
/**
 * Callback handler for R to display information to {@link System#out} and {@link System#err}.
 */
class RConsoleMainLoopCallback implements RMainLoopCallbacks {
    /**
    ...
    public void rBusy(final Rengine rengine, final int which) {
        System.out.println(rengine.getName()
