...
_ALIGNMENTENTRY = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='ambiguity', full_name='goby.AlignmentEntry.ambiguity', index=24,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='bam_attributes', full_name='goby.AlignmentEntry.bam_attributes', index=25,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='read_quality_scores', full_name='goby.AlignmentEntry.read_quality_scores', index=26,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='read_origin_index', full_name='goby.AlignmentEntry.read_origin_index', index=27,
