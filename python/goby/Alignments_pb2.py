...
_ALIGNMENTHEADER = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='all_read_quality_scores', full_name='goby.AlignmentHeader.all_read_quality_scores', index=19,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='read_origin', full_name='goby.AlignmentHeader.read_origin', index=20,
...
_READORIGININFO = descriptor.Descriptor(
  name='ReadOriginInfo',
...
class ReadOriginInfo(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
