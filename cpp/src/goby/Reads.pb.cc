...
bool ReadEntry::IsInitialized() const {
  ...
  for (int i = 0; i < meta_data_size(); i++) {
    if (!this->meta_data(i).IsInitialized()) return false;
  }
  return true;
}
...
const ::std::string MetaData::_default_key_;
const ::std::string MetaData::_default_value_;
#ifndef _MSC_VER
