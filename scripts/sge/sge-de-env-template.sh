...
alignment_basenames=  DLTTEJH-Bullard-HBR-SRR037439.entries  \
...
group2-basenames=LHFEDQE-solid-HBR
annotation_file=/homesD/campagne/dev/goby/data/biomart_human_transcript-exon_ensembl54_NCBI36.txt
use_weights=gc
